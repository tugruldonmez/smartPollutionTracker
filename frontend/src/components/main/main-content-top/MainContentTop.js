    ...
    <div className='  bg-gray-50 rounded-lg'>
        ...
        <div className='flex justify-evenly'>
            ...
            <div id='imgdiv' class="grid grid-rows-1 grid-flow-col w-3/12 gap-2 mx-2 items-center  rounded-lg h-fit text-start p-4">
                ...
                <div id='contentdiv' class="row-span-2 col-span-2 ...">
                    <p className=' font-sans text-2xl font-normal text-gray-900'>Türkiye’de 2017 yılından beri hava kirliliği nedeniyle trafik kazalarının en az 6 katı kadar kişi hayatını kaybetmektedir.</p>
                </div>
            </div>
        </div>
        <div className='flex justify-evenly'>
            <div id='imgdiv' class="grid grid-rows-1 grid-flow-col w-3/12 gap-2 mx-2 items-center  rounded-lg h-fit text-start p-4">
                ...
                <div id='contentdiv' class="row-span-2 col-span-2 ...">
                    <p className=' font-sans text-2xl font-normal text-gray-900'>Tüm dünyada hava kirliliği her yıl 1.4 milyon kalp krizi, 2.4 milyon kalp hastalığı ve 1.8 milyon solunum yolu hastalığı ve akciğer kanserine neden oluyor.
</p>
                </div>
            </div>
            <div id='imgdiv' class="grid grid-rows-1 grid-flow-col w-3/12 gap-2 mx-2 items-center  rounded-lg h-fit text-start p-4">
                ...
                <div id='contentdiv' class="row-span-2 col-span-2 ...">
                    <p className=' font-sans text-2xl font-normal text-gray-900'>2019 yılında, 30 ilde yaşayan yaklaşık 18 milyon kişi (nüfusun %21’i) yıl boyunca soluduğu havanın kalitesine dair yeterli veri yok.</p>
                </div>
            </div>
        </div>
